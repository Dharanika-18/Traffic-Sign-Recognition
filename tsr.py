...
def capture_and_save_photo(file_path='captured_photo.jpg'):
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setStyleSheet("background-color: #ecf0f1;")  # Light gray background
        ...
        self.BrowseImage.setStyleSheet(
            "background-color: #3498db; color: #ffffff; border: 2px solid #2980b9; border-radius: 10px;")

        self.imageLbl = QtWidgets.QLabel(self.centralwidget)
        self.imageLbl.setGeometry(QtCore.QRect(200, 80, 361, 261))
        self.imageLbl.setFrameShape(QtWidgets.QFrame.Box)
        self.imageLbl.setStyleSheet("border: 2px solid #2980b9; border-radius: 10px;")  # Border for the image label
        ...
        self.label_2.setStyleSheet("color: #2c3e50;")  # Dark gray text color
        ...
        self.Classify.setStyleSheet(
            "background-color: #27ae60; color: #ffffff; border: 2px solid #219653; border-radius: 10px;")

        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(430, 370, 111, 16))
        self.label.setObjectName("label")
        self.label.setStyleSheet("color: #2c3e50;")  # Dark gray text color
        ...
        self.Training.setStyleSheet(
            "background-color: #e74c3c; color: #ffffff; border: 2px solid #c0392b; border-radius: 10px;")

        self.textEdit = QtWidgets.QTextEdit(self.centralwidget)
        self.textEdit.setGeometry(QtCore.QRect(400, 390, 211, 51))
        self.textEdit.setObjectName("textEdit")
        self.textEdit.setStyleSheet(
            "background-color: #ffffff; color: #2c3e50; border: 2px solid #34495e; border-radius: 10px; padding: 5px;")
